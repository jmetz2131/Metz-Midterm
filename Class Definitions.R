...
##I have done the exact same thing for the class corresponding to Simpson's Rule called "Simp". Similarly, my class defintion 
##will have the user input what the coordinates are supposed to be for the start and end of the specific curve they wish 
##to "integrate" with this rule. (xStart, yStart) corresponds to point a as shown in the Blackboard presentation and 
##(xEnd, yEnd) corresponds to point b as shown in the Blackboard presentation.
setClass(Class="Simp",
         representation = representation(
           xStart = "numeric", 
           xEnd = "numeric",
...
mySimpson <- new("Simp", xStart=10, xEnd=20, yStart=6, yEnd=7)
class(mySimpson)
